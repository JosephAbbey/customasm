...
fn test_literals() {
    ...
    test(
        "10",
        Pass(expr::Value::make_integer(util::BigInt::new(10, None))),
    );

    test(
        "0b10",
        Pass(expr::Value::make_integer(util::BigInt::new(2, Some(2)))),
    );
    test(
        "0o10",
        Pass(expr::Value::make_integer(util::BigInt::new(8, Some(6)))),
    );
    test(
        "0x10",
        Pass(expr::Value::make_integer(util::BigInt::new(16, Some(8)))),
    );
...
fn test_ops_arithmetic() {
    ...
    test(
        "2 + 2 + 2 + 2",
        Pass(expr::Value::make_integer(util::BigInt::new(8, None))),
    );
    test(
        "2 - 2",
        Pass(expr::Value::make_integer(util::BigInt::new(0, None))),
    ...
    test(
        "2 * 2 * 2 * 2",
        Pass(expr::Value::make_integer(util::BigInt::new(16, None))),
    );
    test(
        "2 / 2",
        Pass(expr::Value::make_integer(util::BigInt::new(1, None))),
    ...
    test(
        "1 << 5",
        Pass(expr::Value::make_integer(util::BigInt::new(32, None))),
    );
    test(
        "1 << 6",
        Pass(expr::Value::make_integer(util::BigInt::new(64, None))),
    );
    test(
        "1 << 7",
        Pass(expr::Value::make_integer(util::BigInt::new(128, None))),
    );
    test(
        "1 << 8",
        Pass(expr::Value::make_integer(util::BigInt::new(256, None))),
    );
    test(
        "1 << 9",
        Pass(expr::Value::make_integer(util::BigInt::new(512, None))),
    );
...
fn test_ops_bitmanipulation() {
    ...
    test(
        "!8",
        Pass(expr::Value::make_integer(util::BigInt::new(-9, None))),
    );
    test(
        "!9",
        Pass(expr::Value::make_integer(util::BigInt::new(-10, None))),
    ...
    test(
        "!16",
        Pass(expr::Value::make_integer(util::BigInt::new(-17, None))),
    );
    test(
        "!32",
        Pass(expr::Value::make_integer(util::BigInt::new(-33, None))),
    );
    test(
        "!64",
        Pass(expr::Value::make_integer(util::BigInt::new(-65, None))),
    );
    test(
        "!128",
        Pass(expr::Value::make_integer(util::BigInt::new(-129, None))),
    );
    test(
        "!256",
        Pass(expr::Value::make_integer(util::BigInt::new(-257, None))),
    );

    test(
        "!-8",
        Pass(expr::Value::make_integer(util::BigInt::new(7, None))),
    );
    test(
        "!-9",
        Pass(expr::Value::make_integer(util::BigInt::new(8, None))),
    ...
    test(
        "0b1100 & 0b1010",
        Pass(expr::Value::make_integer(util::BigInt::new(0b1000, None))),
    );
    test(
        "0b1100 | 0b1010",
        Pass(expr::Value::make_integer(util::BigInt::new(0b1110, None))),
    );
    test(
        "0b1100 ^ 0b1010",
        Pass(expr::Value::make_integer(util::BigInt::new(0b0110, None))),
    );
    ...
    test(
        " 1 |  2",
        Pass(expr::Value::make_integer(util::BigInt::new(3, None))),
    );
    test(
        "-1 |  2",
        Pass(expr::Value::make_integer(util::BigInt::new(-1, None))),
    ...
    test(
        "-0x0001 & 0xffff",
        Pass(expr::Value::make_integer(util::BigInt::new(0xffff, None))),
    );
    test(
        " 0x0001 | 0xffff",
        Pass(expr::Value::make_integer(util::BigInt::new(0xffff, None))),
    ...
    test(
        " 0x0001 ^ 0xffff",
        Pass(expr::Value::make_integer(util::BigInt::new(0xfffe, None))),
    );
    test(
        "-0x0001 ^ 0xffff",
        Pass(expr::Value::make_integer(util::BigInt::new(-0x10000, None))),
    );
...
fn test_ops_slice() {
    test(
        "0x00`8",
        Pass(expr::Value::make_integer(util::BigInt::new(0, Some(8)))),
    );
    test(
        "0x0f`8",
        Pass(expr::Value::make_integer(util::BigInt::new(0xf, Some(8)))),
    );
    test(
        "0xff`8",
        Pass(expr::Value::make_integer(util::BigInt::new(0xff, Some(8)))),
    );
    test(
        "0x101`8",
    ...
    test(
        "0x00[0:0]",
        Pass(expr::Value::make_integer(util::BigInt::new(0, Some(1)))),
    );
    test(
        "0x0f[0:0]",
        Pass(expr::Value::make_integer(util::BigInt::new(1, Some(1)))),
    );
    test(
        "0xff[0:0]",
        Pass(expr::Value::make_integer(util::BigInt::new(1, Some(1)))),
    ...
    test(
        "0x0f[8:1]",
        Pass(expr::Value::make_integer(util::BigInt::new(0x7, Some(8)))),
    );
    test(
        "0xff[8:1]",
    ...
    test(
        "0x12345678[ 3: 0]",
        Pass(expr::Value::make_integer(util::BigInt::new(0x8, Some(4)))),
    );
    test(
        "0x12345678[ 7: 4]",
        Pass(expr::Value::make_integer(util::BigInt::new(0x7, Some(4)))),
    );
    test(
        "0x12345678[11: 8]",
        Pass(expr::Value::make_integer(util::BigInt::new(0x6, Some(4)))),
    );
    test(
        "0x12345678[15:12]",
        Pass(expr::Value::make_integer(util::BigInt::new(0x5, Some(4)))),
    );
    test(
        "0x12345678[19:16]",
        Pass(expr::Value::make_integer(util::BigInt::new(0x4, Some(4)))),
    );
    test(
        "0x12345678[23:20]",
        Pass(expr::Value::make_integer(util::BigInt::new(0x3, Some(4)))),
    );
    test(
        "0x12345678[27:24]",
        Pass(expr::Value::make_integer(util::BigInt::new(0x2, Some(4)))),
    );
    test(
        "0x12345678[31:28]",
        Pass(expr::Value::make_integer(util::BigInt::new(0x1, Some(4)))),
    );
    ...
    test(
        "-0x08[7:0]",
        Pass(expr::Value::make_integer(util::BigInt::new(0xf8, Some(8)))),
    );
    test(
        "-0x7f[7:0]",
        Pass(expr::Value::make_integer(util::BigInt::new(0x81, Some(8)))),
    );
    test(
        "-0x80[7:0]",
        Pass(expr::Value::make_integer(util::BigInt::new(0x80, Some(8)))),
    );
    test(
        "-0x81[7:0]",
        Pass(expr::Value::make_integer(util::BigInt::new(0x7f, Some(8)))),
...
fn test_ops_concat() {
    test(
        "0`8     @ 0`8",
        Pass(expr::Value::make_integer(util::BigInt::new(0, Some(16)))),
    );
    test(
        "0x12`8  @ 0x34`8",
        Pass(expr::Value::make_integer(util::BigInt::new(
            0x1234,
            Some(16),
        ))),
    );
    ...
    test(
        "(6 + 6)[3:0] @ (5 + 5)[3:0]",
        Pass(expr::Value::make_integer(util::BigInt::new(0xca, Some(8)))),
    );
    ...
    test(
        "0x0`4 @ 0x0`4 @ 0x8`4 @ 0x9`4",
        Pass(expr::Value::make_integer(util::BigInt::new(0x89, Some(16)))),
    );
    test(
        "0x1 @ (0x0`4 @ 0x0`4 @ 0x8`4 @ 0x9`4)",
        Pass(expr::Value::make_integer(util::BigInt::new(
            0x10089,
            Some(20),
        ))),
...
fn test_ops_ternary() {
    test(
        "(1 == 1) ? 123",
        Pass(expr::Value::make_integer(util::BigInt::new(123, None))),
    );
    ...
    test(
        "(1 == 0) ? 123 : 456",
        Pass(expr::Value::make_integer(util::BigInt::new(456, None))),
    );
    ...
    test(
        "(1 == 0) ? 123 : (1 == 0) ? 456 : 789",
        Pass(expr::Value::make_integer(util::BigInt::new(789, None))),
    );
...
fn test_precedence() {
    test(
        " 2 +  2  * 2 ",
        Pass(expr::Value::make_integer(util::BigInt::new(6, None))),
    );
    test(
        " 2 + (2  * 2)",
        Pass(expr::Value::make_integer(util::BigInt::new(6, None))),
    ...
    test(
        "0b110 == 0b110 && 0b11 == 0b11",
        Pass(expr::Value::Bool(true)),
    );
    test(
        "0b110 == 0b110 &  0b11 == 0b11",
        Fail(("test", 1, "argument")),
    );
    test(
        "0b110 == 0b110 || 0b11 == 0b11",
        Pass(expr::Value::Bool(true)),
...
fn test_blocks() {
    ...
    test(
        "{1 + 2, 3} + {4, 5 + 6}",
        Pass(expr::Value::make_integer(util::BigInt::new(14, None))),
    );
}
...
fn test_assignment() {
    ...
    test(
        "{ x = 123, y = 321,            x + y }",
        Pass(expr::Value::make_integer(util::BigInt::new(444, None))),
    );
    test(
        "{ x = 123, y = x * 2,          x + y }",
        Pass(expr::Value::make_integer(util::BigInt::new(369, None))),
    );
    test(
        "{ x = 123, y = x * 2, x = 753, x + y }",
        Pass(expr::Value::make_integer(util::BigInt::new(999, None))),
    );

    test(
        "{ x = 123, y = 456, x < y ? min = x : min = y, min }",
        Pass(expr::Value::make_integer(util::BigInt::new(123, None))),
    );
    test(
        "{ x = 456, y = 123, x < y ? min = x : min = y, min }",
        Pass(expr::Value::make_integer(util::BigInt::new(123, None))),
    );

    test(
        "{ x = 123, y = 456, x < y ? min = x,           min }",
        Pass(expr::Value::make_integer(util::BigInt::new(123, None))),
    );
    test(
