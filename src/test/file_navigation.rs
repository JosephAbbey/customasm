...
fn test_file_navigation() {
    ...
    test(
        "folder/inner.asm",
        "./sibling.asm",
        Ok("folder/sibling.asm"),
    );
    test(
        "folder/inner.asm",
        "folder/inner.asm",
        Ok("folder/folder/inner.asm"),
    );
    test(
        "folder/inner.asm",
        "./folder/inner.asm",
    ...
    test("folder/subfolder/inner.asm", ".", Err(()));
    test(
        "folder/subfolder/inner.asm",
        "sibling.asm",
        Ok("folder/subfolder/sibling.asm"),
    );
    test(
        "folder/subfolder/inner.asm",
        "./sibling.asm",
    ...
    test(
        "folder/subfolder/inner.asm",
        "folder/inner.asm",
        Ok("folder/subfolder/folder/inner.asm"),
    );
    test(
        "folder/subfolder/inner.asm",
        "./folder/inner.asm",
...
fn test(base: &str, relative: &str, expected: Result<&str, ()>) {
    ...
    let result = util::filename_navigate(&mut report, span, base, relative);
